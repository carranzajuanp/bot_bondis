...
rm(data)
# Ver cómo tomar las coordenadas directamente del campo properties.coordinates.
...
# n = paginado del json. Esto se tiene que poder hacer menos feo. Quizás un while.
for ( i in 2:n) {
